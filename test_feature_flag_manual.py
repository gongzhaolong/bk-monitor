...
"""
手动测试特性开关数据库功能
使用方法：在项目根目录运行 python3 test_feature_flag_manual.py
"""
import os
import sys
...
# 设置必要的环境变量
os.environ.setdefault("BKAPP_DEPLOY_PLATFORM", "enterprise")
...
def main():
    ...
    try:
        ...
        print("请先运行迁移: python manage.py migrate metadata 0249_featureflag")
        return
    print()
